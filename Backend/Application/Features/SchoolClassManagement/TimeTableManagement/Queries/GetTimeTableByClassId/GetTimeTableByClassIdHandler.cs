...
public class GetTimeTableByTeacherIdHandler : IRequestHandler<GetTimeTableByClassIdQuery, IEnumerable<TimeTableResponseDto>>
{
    ...
    public async Task<IEnumerable<TimeTableResponseDto>> Handle(GetTimeTableByClassIdQuery request, CancellationToken cancellationToken)
    {
        Expression<Func<TimeTable, bool>> filter = tt => tt.ClassId == request.ClassId;
